...
public class HandDetection : MonoBehaviour
{
    ...
    async Awaitable Detect(Texture texture)
    {
        ...
        bool indexExtended = Vector3.Distance(jointPositions[8], wrist) > Vector3.Distance(jointPositions[6], wrist) * 1.1f;
        bool middleExtended = Vector3.Distance(jointPositions[12], wrist) > Vector3.Distance(jointPositions[10], wrist) * 1.1f;
        bool ringExtended = Vector3.Distance(jointPositions[16], wrist) > Vector3.Distance(jointPositions[14], wrist) * 1.1f;
        bool pinkyExtended = Vector3.Distance(jointPositions[20], wrist) > Vector3.Distance(jointPositions[18], wrist) * 1.1f;
