...
public class HandDetection : MonoBehaviour
{
    ...
    public PinchOrbController pinchOrbController;
    ...
    async Awaitable Detect(Texture texture)
    {
        ...
        float normalizedFTDistance = (indexTip - thumpTip).magnitude / (thumpTip - wrist).magnitude;

        bool isPinching = normalizedFTDistance < pinchThreshold;

        if (pinchOrbController != null)
        {
            pinchOrbController.UpdateOrb(indexTip, isPinching);
        }
